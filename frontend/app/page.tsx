...
export default async function Home() {
  ...
  return (
    ...
    //         of managing and verifying users&apos; identities digitally. It
    //         offers various functionalities to support decentralized identity
    ...
    //           tamper-proof way to verify users&apos; attributes and
    //           qualifications.
    //         </p>
